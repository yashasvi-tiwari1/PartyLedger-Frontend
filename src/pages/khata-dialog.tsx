...
const KhataDialog: React.FC<DialogProps> = ({
  isOpen,
  onClose,
  customer = { item: "", unitPrice: "", quantity: "" },
}) => {
  ...
  const handleItemChange: React.ChangeEventHandler<HTMLInputElement> = (e) => {
